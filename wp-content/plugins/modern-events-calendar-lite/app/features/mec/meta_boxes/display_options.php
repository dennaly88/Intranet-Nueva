    ...
    <div class="mec-meta-box-fields" id="mec_meta_box_calendar_skin_options">
        ...
        <div class="mec-skins-options-container">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_grid_skin_options_container">
                ...
                <div class="mec-form-row mec-skin-grid-date-format-container <?php if(isset($sk_options_grid['style']) and $sk_options_grid['style'] != 'simple') echo 'mec-util-hidden'; ?>" id="mec_skin_grid_date_format_simple_container">
                    ...
                    <span class="mec-tooltip">
                        <div class="box top">
                            <h5 class="title"><?php esc_html_e('Date Formats', 'modern-events-calendar-lite'); ?></h5>
                            <div class="content"><p><?php esc_attr_e('Default value is "M d Y"', 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/grid-view-skin/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                        </div>
                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                    </span>
                </div>
                ...
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
                        <label for="mec_skin_grid_load_more_button"><?php esc_html_e('Load More Button', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_agenda_skin_options_container">
                ...
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
                        <label for="mec_skin_agenda_load_more_button"><?php esc_html_e('Load More Button', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_full_calendar_skin_options_container">
                ...
                <p class="description"><?php esc_html_e("The price shows only in List View.", 'modern-events-calendar-lite'); ?></p>
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
                        <label for="mec_skin_full_calendar_display_price"><?php esc_html_e('Display Event Price', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_masonry_skin_options_container">
                ...
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
                        <label><?php esc_html_e('Load More Button', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-col-4">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_timeline_skin_options_container">
                ...
                <div class="mec-form-row mec-switcher">
                    <div class="mec-col-4">
                        <label for="mec_skin_timeline_load_more_button"><?php esc_html_e('Load More Button', 'modern-events-calendar-lite'); ?></label>
                    </div>
                    <div class="mec-col-4">
