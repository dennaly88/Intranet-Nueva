                ...
                <div class="mec-container">
                    ...
                    <form id="mec_single_form">
                                ...
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            ...
                                            <div class="content"><p><?php esc_attr_e("Default is M d Y", 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/event-detailssingle-event-page/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                        </div>
                                ...
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            ...
                                            <div class="content"><p><?php esc_attr_e('Referred date" shows the event date based on referred date in event list.', 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/event-detailssingle-event-page/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                                ...
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            ...
                                            <div class="content"><p><?php esc_attr_e("Check this option, for showing the breadcrumbs on single event page", 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/event-detailssingle-event-page/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                            ...
                            <div class="mec-form-row">
                                ...
                                <div class="mec-col-9">
                                    <label id="mec_settings_organizer_description" >
                                        ...
                                        <input type="checkbox" name="mec[settings][organizer_description]" id="mec_settings_organizer_description" <?php echo ((isset($settings['organizer_description']) and $settings['organizer_description']) ? 'checked="checked"' : ''); ?> value="1" /><?php esc_html_e('Enable Description For Organizer.', 'modern-events-calendar-lite'); ?>
                                    </label>
                                    <span class="mec-tooltip">
                                        <div class="box left">
                            ...
                            <div class="mec-form-row">
                                ...
                                <div class="mec-col-9">
                                    <label id="mec_settings_location_description" >
                                        ...
                                        <input type="checkbox" name="mec[settings][location_description]" id="mec_settings_location_description" <?php echo ((isset($settings['location_description']) and $settings['location_description']) ? 'checked="checked"' : ''); ?> value="1" /><?php esc_html_e('Enable Description For Location.', 'modern-events-calendar-lite'); ?>
                                    </label>
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                ...
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            ...
                                            <div class="content"><p><?php esc_attr_e("If enabled, an upload field will appear in add / edit event page and if filled, it will appear in the event details page to download.", 'modern-events-calendar-lite'); ?></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                            ...
                            <div id="mec_count_down_container_toggle" class="<?php if((isset($settings['countdown_status']) and !$settings['countdown_status']) or !isset($settings['countdown_status'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row">
                                    <div class="mec-col-12">
                                        ...
                                        <label for="mec_settings_countdown_disable_for_ongoing_events"><?php esc_html_e('Disable for ongoing events', 'modern-events-calendar-lite'); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <label>
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            ...
                                            <div class="content"><p><?php esc_attr_e("Using this option you can exclude certain days from event occurrence dates.", 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/exceptional-days/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </label>
                        ...
                        <div id="per_occurrences" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php esc_html_e('Edit Per Occurrences', 'modern-events-calendar-lite'); ?></h4>
                            <div class="mec-form-row">
                                <label>
