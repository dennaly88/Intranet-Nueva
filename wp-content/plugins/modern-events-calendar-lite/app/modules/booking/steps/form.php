...
<form id="mec_book_form<?php echo esc_attr($uniqueid); ?>" class="mec-booking-form-container row" onsubmit="mec_book_form_submit(event, <?php echo esc_attr($uniqueid); ?>);" novalidate="novalidate" enctype="multipart/form-data" method="post">
    <h4><?php echo apply_filters('mec-booking-attendees-title', esc_html__('Attendee\'s Form', 'modern-events-calendar-lite'), $event_id) ?></h4>
    ...
    <?php if (!$custom_view_fields && $have_bfixed_fields): ?>
        <ul class="mec-book-bfixed-fields-container">
            <?php foreach ($bfixed_fields as $bfixed_field_id => $bfixed_field) : if (!is_numeric($bfixed_field_id) or !isset($bfixed_field['type'])) continue; ?>
                <li class="mec-book-bfixed-field-<?php echo esc_attr($bfixed_field['type']); ?> <?php echo ((isset($bfixed_field['mandatory']) and $bfixed_field['mandatory']) ? 'mec-reg-mandatory' : ''); ?>" data-field-id="<?php echo esc_attr($bfixed_field_id); ?>">

                    <?php if (isset($bfixed_field['label']) and $bfixed_field['type'] != 'agreement') : ?>
                        <label for="mec_book_bfixed_field_reg<?php echo esc_attr($bfixed_field_id); ?>"><?php esc_html_e($bfixed_field['label'], 'modern-events-calendar-lite'); ?><?php echo ((isset($bfixed_field['mandatory']) and $bfixed_field['mandatory']) ? '<span class="wbmec-mandatory">*</span>' : ''); ?></label>
                    <?php endif; ?>

                    <?php /** Text **/ if ($bfixed_field['type'] == 'text') : ?>
                        <input id="mec_book_bfixed_field_reg<?php echo esc_attr($bfixed_field_id); ?>" type="text" name="book[fields][<?php echo esc_attr($bfixed_field_id); ?>]" value="" placeholder="<?php if (isset($bfixed_field['placeholder']) and $bfixed_field['placeholder']) {
                    ...
                    <?php /** Email **/ elseif ($bfixed_field['type'] == 'email') : ?>
                        <input id="mec_book_bfixed_field_reg<?php echo esc_attr($bfixed_field_id); ?>" type="email" name="book[fields][<?php echo esc_attr($bfixed_field_id); ?>]" value="" placeholder="<?php if (isset($bfixed_field['placeholder']) and $bfixed_field['placeholder']) {
                            esc_html_e($bfixed_field['placeholder'], 'modern-events-calendar-lite');
                        } else {
                            esc_html_e($bfixed_field['label'], 'modern-events-calendar-lite');
                    ...
                    <?php /** Tel **/ elseif ($bfixed_field['type'] == 'tel') : ?>
                        <input id="mec_book_bfixed_field_reg<?php echo esc_attr($bfixed_field_id); ?>" oninput="this.value=this.value.replace(/(?![0-9])./gmi,'')" type="tel" name="book[fields][<?php echo esc_attr($bfixed_field_id); ?>]" value="" placeholder="<?php if (isset($bfixed_field['placeholder']) and $bfixed_field['placeholder']) {
                            esc_html_e($bfixed_field['placeholder'], 'modern-events-calendar-lite');
                        } else {
                            esc_html_e($bfixed_field['label'], 'modern-events-calendar-lite');
                        }; ?>" <?php if (isset($bfixed_field['mandatory']) and $bfixed_field['mandatory']) echo 'required'; ?> />
                    ...
                    <?php /** Textarea **/ elseif ($bfixed_field['type'] == 'textarea') : ?>
                        <textarea id="mec_book_bfixed_field_reg<?php echo esc_attr($bfixed_field_id); ?>" name="book[fields][<?php echo esc_attr($bfixed_field_id); ?>]" placeholder="<?php if (isset($bfixed_field['placeholder']) and $bfixed_field['placeholder']) {
                            esc_html_e($bfixed_field['placeholder'], 'modern-events-calendar-lite');
                        } else {
                            esc_html_e($bfixed_field['label'], 'modern-events-calendar-lite');
                    ...
                    <?php /** Dropdown **/ elseif ($bfixed_field['type'] == 'select') : ?>
                        <select id="mec_book_bfixed_field_reg<?php echo esc_attr($bfixed_field_id); ?>" name="book[fields][<?php echo esc_attr($bfixed_field_id); ?>]" placeholder="<?php if (isset($bfixed_field['placeholder']) and $bfixed_field['placeholder']) {
                            esc_html_e($bfixed_field['placeholder'], 'modern-events-calendar-lite');
                        } else {
                            esc_html_e($bfixed_field['label'], 'modern-events-calendar-lite');
                        }; ?>" <?php if (isset($bfixed_field['mandatory']) and $bfixed_field['mandatory']) echo 'required'; ?>>
                            <?php $bfd = 0; foreach ($bfixed_field['options'] as $bfixed_field_option) : $bfd++; ?>
                                <option value="<?php echo (($bfd == 1 and isset($bfixed_field['ignore']) and $bfixed_field['ignore']) ? '' : esc_attr__($bfixed_field_option['label'], 'modern-events-calendar-lite')); ?>"><?php esc_html_e($bfixed_field_option['label'], 'modern-events-calendar-lite'); ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <?php /** Radio **/ elseif ($bfixed_field['type'] == 'radio') : ?>
                        <?php foreach ($bfixed_field['options'] as $bfixed_field_option) : ?>
                            <label for="mec_book_bfixed_field_reg<?php echo esc_attr($bfixed_field_id . '_' . strtolower(str_replace(' ', '_', $bfixed_field_option['label']))); ?>">
                                <input type="radio" id="mec_book_bfixed_field_reg<?php echo esc_attr($bfixed_field_id . '_' . strtolower(str_replace(' ', '_', $bfixed_field_option['label']))); ?>" name="book[fields][<?php echo esc_attr($bfixed_field_id); ?>]" value="<?php esc_html_e($bfixed_field_option['label'], 'modern-events-calendar-lite'); ?>" />
                                <?php esc_html_e($bfixed_field_option['label'], 'modern-events-calendar-lite'); ?>
                            </label>
                        <?php endforeach; ?>
                    ...
                    <?php /** Checkbox **/ elseif ($bfixed_field['type'] == 'checkbox') : ?>
                        <?php foreach ($bfixed_field['options'] as $bfixed_field_option) : ?>
                            <label for="mec_book_bfixed_field_reg<?php echo esc_attr($bfixed_field_id . '_' . strtolower(str_replace(' ', '_', $bfixed_field_option['label']))); ?>">
                                <input type="checkbox" id="mec_book_bfixed_field_reg<?php echo esc_attr($bfixed_field_id . '_' . strtolower(str_replace(' ', '_', $bfixed_field_option['label']))); ?>" name="book[fields][<?php echo esc_attr($bfixed_field_id); ?>][]" value="<?php esc_html_e($bfixed_field_option['label'], 'modern-events-calendar-lite'); ?>" />
                                <?php esc_html_e($bfixed_field_option['label'], 'modern-events-calendar-lite'); ?>
                            </label>
                        <?php endforeach; ?>
    ...
    <ul class="mec-book-tickets-container">
        ...
        foreach ($tickets as $ticket_id => $count) : if (!$count) continue;
            ...
            for ($i = 1; $i <= $count; $i++) : $j++;
                $ticket_price = $this->book->get_ticket_price($ticket, current_time('Y-m-d'), $event_id);
                ...
                <li class="mec-book-ticket-container <?php echo (($j > 1 and $first_for_all) ? 'mec-util-hidden' : ''); ?>">
                    <?php if (!empty($ticket['name']) || !empty($this->book->get_ticket_price_label($ticket, current_time('Y-m-d'), $event_id))) : ?>
                        <h4 class="col-md-12">
                            ...
                            <?php
                                $ticket_price = $this->book->get_ticket_price_label($ticket, current_time('Y-m-d'), $event_id);
                                $ticket_price = apply_filters('mec_filter_ticket_price_label', $ticket_price, $ticket, $event_id, $this->book);
                            ?>
                    ...
                    <?php if (count($reg_fields)) : foreach ($reg_fields as $reg_field_id => $reg_field) : if (!is_numeric($reg_field_id) or !isset($reg_field['type'])) continue; ?>
                        ...
                        <?php endif; ?>
                        <div class="mec-book-reg-field-<?php echo esc_attr($reg_field['type']); ?> <?php echo ((isset($reg_field['mandatory']) and $reg_field['mandatory']) ? 'mec-reg-mandatory' : ''); ?><?php
                        ...
                        ?>" data-ticket-id="<?php echo esc_attr($j); ?>" data-field-id="<?php echo esc_attr($reg_field_id); ?>">
                            <?php if (isset($reg_field['label']) and $reg_field['type'] != 'agreement' &&  $reg_field['type'] != 'name' && $reg_field['type'] != 'mec_email') : ?><label for="mec_book_reg_field_reg<?php echo esc_attr($j . '_' . $reg_field_id); ?>"><?php esc_html_e($reg_field['label'], 'modern-events-calendar-lite'); ?><?php echo ((isset($reg_field['mandatory']) and $reg_field['mandatory']) ? '<span class="wbmec-mandatory">*</span>' : ''); ?></label><?php endif; ?>

                            <?php /** Name **/ if ($reg_field['type'] == 'name') : ?>
                                <?php $reg_field['label'] = ($reg_field['label']) ? $reg_field['label'] : 'Name'; ?>
                                <label for="mec_book_reg_field_name<?php echo esc_attr($reg_field_id); ?>"><?php esc_html_e($reg_field['label'], 'modern-events-calendar-lite'); ?><span class="wbmec-mandatory">*</span></label>
                                <input id="mec_book_reg_field_name<?php echo esc_attr($reg_field_id); ?>" type="text" name="book[tickets][<?php echo esc_attr($j); ?>][name]" value="<?php echo trim((isset($current_user->user_firstname) ? $current_user->user_firstname : '') . ' ' . (isset($current_user->user_lastname) ? $current_user->user_lastname : '')); ?>" placeholder="<?php if (isset($reg_field['placeholder']) and $reg_field['placeholder']) {
                            ...
                            <?php /** File **/ elseif ($reg_field['type'] == 'file') : ?>
                                <input id="mec_book_reg_field_reg<?php echo esc_attr($j . '_' . $reg_field_id); ?>" type="file" name="book[tickets][<?php echo esc_attr($j); ?>][reg][<?php echo esc_attr($reg_field_id); ?>]" value="" placeholder="<?php if (isset($reg_field['placeholder']) and $reg_field['placeholder']) {
                                    esc_html_e($reg_field['placeholder'], 'modern-events-calendar-lite');
                                } else {
                                    esc_html_e($reg_field['label'], 'modern-events-calendar-lite');
                            ...
                            <?php /** Email **/ elseif ($reg_field['type'] == 'email') : ?>
                                <input id="mec_book_reg_field_reg<?php echo esc_attr($j . '_' . $reg_field_id); ?>" type="email" name="book[tickets][<?php echo esc_attr($j); ?>][reg][<?php echo esc_attr($reg_field_id); ?>]" value="<?php echo esc_attr($this->main->get_from_mapped_field($reg_field)); ?>" placeholder="<?php if (isset($reg_field['placeholder']) and $reg_field['placeholder']) {
                                    esc_html_e($reg_field['placeholder'], 'modern-events-calendar-lite');
                                } else {
                                    esc_html_e($reg_field['label'], 'modern-events-calendar-lite');
                                }; ?>" <?php if (isset($reg_field['mandatory']) and $reg_field['mandatory']) echo 'required'; ?> />
                            ...
                            <?php /** Tel **/ elseif ($reg_field['type'] == 'tel') : ?>
                                <input id="mec_book_reg_field_reg<?php echo esc_attr($j . '_' . $reg_field_id); ?>" oninput="this.value=this.value.replace(/(?![0-9])./gmi,'')" type="tel" name="book[tickets][<?php echo esc_attr($j); ?>][reg][<?php echo esc_attr($reg_field_id); ?>]" value="<?php echo esc_attr($this->main->get_from_mapped_field($reg_field)); ?>" placeholder="<?php if (isset($reg_field['placeholder']) and $reg_field['placeholder']) {
                                    esc_html_e($reg_field['placeholder'], 'modern-events-calendar-lite');
                                } else {
                                    esc_html_e($reg_field['label'], 'modern-events-calendar-lite');
                                }; ?>" <?php if (isset($reg_field['mandatory']) and $reg_field['mandatory']) echo 'required'; ?> />
                            ...
                            <?php /** Textarea **/ elseif ($reg_field['type'] == 'textarea') : ?>
                                <textarea id="mec_book_reg_field_reg<?php echo esc_attr($j . '_' . $reg_field_id); ?>" name="book[tickets][<?php echo esc_attr($j); ?>][reg][<?php echo esc_attr($reg_field_id); ?>]" placeholder="<?php if (isset($reg_field['placeholder']) and $reg_field['placeholder']) {
                                    esc_html_e($reg_field['placeholder'], 'modern-events-calendar-lite');
                                } else {
                                    esc_html_e($reg_field['label'], 'modern-events-calendar-lite');
                            ...
                            <?php /** Dropdown **/ elseif ($reg_field['type'] == 'select') : ?>
                                <select id="mec_book_reg_field_reg<?php echo esc_attr($j . '_' . $reg_field_id); ?>" name="book[tickets][<?php echo esc_attr($j); ?>][reg][<?php echo esc_attr($reg_field_id); ?>]" placeholder="<?php if (isset($reg_field['placeholder']) and $reg_field['placeholder']) {
                                    esc_html_e($reg_field['placeholder'], 'modern-events-calendar-lite');
                                } else {
                                    esc_html_e($reg_field['label'], 'modern-events-calendar-lite');
                                }; ?>" <?php if (isset($reg_field['mandatory']) and $reg_field['mandatory']) echo 'required'; ?>>
                                    <?php $rd = 0; $s_value = $this->main->get_from_mapped_field($reg_field); foreach ($reg_field['options'] as $reg_field_option) : $rd++; ?>
                                        <option value="<?php echo (($rd == 1 and isset($reg_field['ignore']) and $reg_field['ignore']) ? '' : esc_attr__($reg_field_option['label'], 'modern-events-calendar-lite')); ?>" <?php echo (($s_value and $s_value == esc_html__($reg_field_option['label'], 'modern-events-calendar-lite')) ? 'selected="selected"' : ''); ?>><?php esc_html_e($reg_field_option['label'], 'modern-events-calendar-lite'); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <?php /** Radio **/ elseif ($reg_field['type'] == 'radio') : ?>
                                <?php $r_value = $this->main->get_from_mapped_field($reg_field); foreach ($reg_field['options'] as $reg_field_option) : ?>
                                    <label for="mec_book_reg_field_reg<?php echo esc_attr($j . '_' . $reg_field_id . '_' . strtolower(str_replace(' ', '_', $reg_field_option['label']))); ?>">
                                        <input type="radio" id="mec_book_reg_field_reg<?php echo esc_attr($j . '_' . $reg_field_id . '_' . strtolower(str_replace(' ', '_', $reg_field_option['label']))); ?>" name="book[tickets][<?php echo esc_attr($j); ?>][reg][<?php echo esc_attr($reg_field_id); ?>]" value="<?php esc_html_e($reg_field_option['label'], 'modern-events-calendar-lite'); ?>" <?php echo (($r_value and $r_value == esc_html__($reg_field_option['label'], 'modern-events-calendar-lite')) ? 'checked="checked"' : ''); ?> />
                                        <?php esc_html_e($reg_field_option['label'], 'modern-events-calendar-lite'); ?>
                                    </label>
                                <?php endforeach; ?>
                            ...
                            <?php /** Checkbox **/ elseif ($reg_field['type'] == 'checkbox') : ?>
                                <?php $c_values = array_map('trim', explode(',', $this->main->get_from_mapped_field($reg_field))); foreach ($reg_field['options'] as $reg_field_option) : ?>
                                    <label for="mec_book_reg_field_reg<?php echo esc_attr($j . '_' . $reg_field_id . '_' . strtolower(str_replace(' ', '_', $reg_field_option['label']))); ?>">
                                        <input type="checkbox" id="mec_book_reg_field_reg<?php echo esc_attr($j . '_' . $reg_field_id . '_' . strtolower(str_replace(' ', '_', $reg_field_option['label']))); ?>" name="book[tickets][<?php echo esc_attr($j); ?>][reg][<?php echo esc_attr($reg_field_id); ?>][]" value="<?php esc_html_e($reg_field_option['label'], 'modern-events-calendar-lite'); ?>" <?php echo (($c_values and is_array($c_values) and in_array(__($reg_field_option['label'], 'modern-events-calendar-lite'), $c_values)) ? 'checked="checked"' : ''); ?> />
                                        <?php esc_html_e($reg_field_option['label'], 'modern-events-calendar-lite'); ?>
                                    </label>
                                <?php endforeach; ?>
                    ...
                    <?php if(isset($this->settings['ticket_variations_status']) and $this->settings['ticket_variations_status'] and count($ticket_variations)): foreach($ticket_variations as $ticket_variation_id => $ticket_variation): if(!is_numeric($ticket_variation_id) or !isset($ticket_variation['title']) or (isset($ticket_variation['title']) and !trim($ticket_variation['title']))) continue; ?>
                        <div class="col-md-12">
                            <div class="mec-book-ticket-variation" data-ticket-id="<?php echo esc_attr($j); ?>" data-ticket-variation-id="<?php echo esc_attr($ticket_variation_id); ?>">
                                <h5><span class="mec-ticket-variation-name"><?php echo esc_html($ticket_variation['title']); ?></span><span class="mec-ticket-variation-price"><?php echo MEC_kses::element($this->main->render_price($ticket_variation['price'], $event_id)); ?></span></h5>
    ...
    <div class="mec-book-form-btn-wrap" style="overflow: hidden;">
        ...
        <?php if(!$step_skipped): ?>
        <button id="mec-book-form-back-btn-step-2" class="mec-book-form-back-button" type="button" onclick="mec_book_form_back_btn_click(this);"><?php esc_html_e('Back', 'modern-events-calendar-lite'); ?></button>
        <?php endif; ?>

        <button id="mec-book-form-btn-step-2" class="mec-book-form-next-button" type="submit" onclick="mec_book_form_back_btn_cache(this, <?php echo esc_attr($uniqueid); ?>);" <?php echo ($step_skipped ? 'style="margin-left: 0;"' : ''); ?>><?php echo (($WC_status or $cart_status) ? esc_html__('Add to Cart', 'modern-events-calendar-lite') : ((!$total_ticket_prices and !$has_fees and !$has_variations && $check_free_tickets_booking) ? esc_html__('Submit', 'modern-events-calendar-lite') : esc_html__('Next', 'modern-events-calendar-lite'))); ?></button>
    </div>
</form>
<style>
    .nice-select {
